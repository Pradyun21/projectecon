...
import { ArrowDown, BookOpen, GraduationCap, MapPin, ScanSearch } from "lucide-react";
...
export default function About() {
  return <>
    ...
    </Reveal><Reveal className="process-next-wrap"><a className="process-next" href="#about-story"><span><small>Continue</small><strong>See why Project Econ exists</strong></span><i aria-hidden="true"><ArrowDown size={18}/></i></a></Reveal></div></section>
    ...
    </div><div className="container"><Reveal className="process-next-wrap"><a className="process-next" href="#about-principles"><span><small>Keep exploring</small><strong>Discover the vision and values</strong></span><i aria-hidden="true"><ArrowDown size={18}/></i></a></Reveal></div></section>
